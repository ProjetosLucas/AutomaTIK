...
<div class="loan form large-9 medium-8 columns content">
        ...
        <h1 class="title">Student By Name</h1>
<div class="jumbotron" style="background:none">
          <div class="container">
            <div id="async-buttons" style="display: none;"></div><br>
            <div id="buttons" style="display: none;"></div><br>
...
function  InsertCodeByName(aux){
  ...
  document.getElementById("student-code").value = testdata.registration[index];
}
</script>
<script>
  ;(function() {
