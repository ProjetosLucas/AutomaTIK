 ...
 * @var \App\Model\Entity\Localization[]|\Cake\Collection\CollectionInterface $localizations
 */
?>
...
<div class="localizations index large-9 medium-8 columns content">
    <h3><?= __('Localizations') ?></h3>
