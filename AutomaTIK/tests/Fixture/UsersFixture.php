...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'usermame' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'usermame' => 'Lorem ipsum dolor ',
                'email' => 'Lorem ipsum dolor sit amet',
                'password' => 'Lorem ipsum dolor sit amet',
                'roles_id' => 1,
                'created' => '2019-05-18 23:42:31',
                'modified' => '2019-05-18 23:42:31'
            ],
        ];
        parent::init();
    }
